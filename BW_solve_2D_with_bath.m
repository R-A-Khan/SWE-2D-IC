function [b, T_adj, Y] = BW_solve_2D_with_bath(h, hy, dt, u0, tmin, tmax, x0_inds, y0_inds, trend, obs, u_all, v_all, eta_all, beta)
% Usage: 
...
tRange = [tmin tmax];
[T_adj,Y] = RK34_BW_2D_with_bath(dt, u0, tRange, trend, h, hy, x0_inds, y0_inds, obs_tau, u_all_tau, v_all_tau, eta_all_tau, beta);
% figure(1);
