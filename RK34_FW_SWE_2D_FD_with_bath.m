function [t,y] = RK34_FW_SWE_2D_FD_with_bath(dt, tRange, trend, u0, delta_x, delta_y, nu, bath)
...
for k = 1 : numSteps
    ...
    U0 = y(:,:,k);
    U1 =  alpha(1,1)*U0                 + dt * beta(1,1)*trend(t,U0,delta_x, delta_y, nu, bath); 
    U2 =  alpha(2,2)*U1                 + dt * beta(2,2)*trend(t,U1,delta_x, delta_y, nu, bath);
    U3 =  alpha(3,1)*U0 + alpha(3,3)*U2 + dt * beta(3,3)*trend(t,U2,delta_x, delta_y, nu, bath);
    U4 =  alpha(4,4)*U3                 + dt * beta(4,4)*trend(t,U3,delta_x, delta_y, nu, bath);
    y(:,:,k+1) = U4;
end