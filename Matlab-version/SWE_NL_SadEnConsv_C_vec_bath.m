function [trend] = SWE_NL_SadEnConsv_C_vec_bath(t, u0, delta_x, delta_y, nu, beta)
...
trend(1:Nx,:)        = -(  forw_diff_u_2D_vec( mid2edge_2D_x_vec(1+eta-beta).*u, delta_x, 1) + forw_diff_u_2D_vec( mid2edge_2D_y_vec(1+eta-beta).*v, delta_y, 2)  );
